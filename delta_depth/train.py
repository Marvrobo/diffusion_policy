...
from model.model import ConditionalUnet1D, get_resnet, replace_bn_with_gn, DepthCNN
...
NUM_EPOCHS = 3000
pred_horizon = 16 + 1 # 1 compensation for computing delta.
obs_horizon = 2
action_horizon = 8
...
# dpeth image encoder
depth_vision_encoder = DepthCNN(out_dim=512)
    ...
    for epoch_idx in tglobal:
        ...
        with tqdm(dataloader, desc='Batch', leave=False) as tepoch:
            ...
            if epoch_idx % 100 == 0 and epoch_idx != 0:
                ...
                print(f"saving the model for {epoch_idx} epochs")
